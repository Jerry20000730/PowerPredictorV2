...
class EnergyPredictorV2_image2heightmap():
    def __init__(self,
        ...
        if test_src_folder_path is None:
            raise AttributeError("[ERROR] the attribute 'test_src_folder_path' for EnergyPredictorV2_image2heightmap is missing")
        if heightmap_src_folder_path is None:
            raise AttributeError("[ERROR] the attribute 'heightmap_src_folder_path' for EnergyPredictorV2_image2heightmap is missing")
        if checkpoint_folder_path is None:
            raise AttributeError("[ERROR] the attribute 'checkpoint_folder_path' for EnergyPredictorV2_image2heightmap is missing")
...
class EnergyPredictorV2_heightmap2powerclass():
    def __init__(self,
        ...
        if train_src_folder_path is None:
            raise AttributeError("[ERROR] the attribute 'train_src_folder_path' for EnergyPredictorV2_heightmap2powerclass is missing")
        if test_src_folder_path is None:
            raise AttributeError("[ERROR] the attribute 'test_src_folder_path' for EnergyPredictorV2_heightmap2powerclass is missing")
        if heightmap_src_folder_path is None:
            raise AttributeError("[ERROR] the attribute 'heightmap_src_folder_path' for EnergyPredictorV2_heightmap2powerclass is missing")
        if checkpoint_folder_path is None:
            raise AttributeError("[ERROR] the attribute 'checkpoint_folder_path' for EnergyPredictorV2_heightmap2powerclass is missing")
